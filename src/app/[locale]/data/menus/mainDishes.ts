export const MainDishes = {
  id: 'main-dishes',
  categorie: 'menu.mainDishes.title',
  i18nKey: "menu.mainDishes",
  plats: [
    {
      label: "menu.mainDishes.items.whole_fried_fish.label",
    ...
    {
      label: "menu.mainDishes.items.shrimp_white_sauce.label",
      description: "menu.mainDishes.items.shrimp_white_sauce.description",
      price: 16
    },
    {
